package im.nucker.ui.ab.render.impl.item;

import com.mojang.blaze3d.matrix.MatrixStack;
import im.nucker.NuckerDLC;
import im.nucker.ui.ab.render.impl.AddedItemComponent;
import im.nucker.ui.ab.render.impl.AllItemComponent;
import im.nucker.ui.ab.render.impl.Component;
import im.nucker.utils.client.IMinecraft;
import im.nucker.utils.components.ButtonComponent;
import im.nucker.utils.components.FieldComponent;
import im.nucker.utils.components.SliderComponent;
...
public class EditComponent extends Component implements IMinecraft {
    ...
    private final ButtonComponent add = new ButtonComponent(0, 0, 0, 0, "Добавить", () -> {
        if (!price.get().isEmpty()) {
            ...
            NuckerDLC.getInstance().getItemStorage().addItem(stack.getItem(), Integer.parseInt(price.get()), Integer.parseInt(count.fieldComponent.get()), Integer.parseInt(damage.fieldComponent.get()), enchantmentWidget.get());
