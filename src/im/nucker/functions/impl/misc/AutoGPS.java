...
public class AutoGPS extends Function {
    public AutoGPS() {
    }
    ...
    private void onPacket(EventPacket packetEvent) {
        ...
        if (var3 instanceof SChatPacket chatPacket) {
            ...
            if (chatMessage.contains("[мистический сундук]") || chatMessage.contains("[вулкан]") || chatMessage.contains("[Снежная]") || chatMessage.contains("[маяк]")) {
