...
public class Config implements IMinecraft {
    ...
    private void loadFunctionSettings(JsonObject functionsObject) {
        NuckerDLC.getInstance().getFunctionRegistry().getFunctions().forEach(f -> {
    ...
    private void saveFunctionSettings(JsonObject functionsObject) {
        NuckerDLC.getInstance().getFunctionRegistry().getFunctions().forEach(module -> {
    ...
    private void saveStyleSettings(JsonObject stylesObject) {
        for (Style style : NuckerDLC.getInstance().getStyleManager().getStyleList()) {
            ...
            styleObject.addProperty("selected", NuckerDLC.getInstance().getStyleManager().getCurrentStyle() == style);
