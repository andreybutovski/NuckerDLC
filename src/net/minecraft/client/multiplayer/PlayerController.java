...
import im.nucker.functions.impl.player.NoInteract;
...
public class PlayerController {
    ...
    public void processRightClickBlock(PlayerEntity player, ClientWorld world, BlockPos pos, Direction horizontalFacing, Vector3d lookVec, Hand hand) {
    }
}
