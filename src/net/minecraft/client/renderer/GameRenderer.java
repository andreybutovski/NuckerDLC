...
import im.nucker.events.EventCancelOverlay;
import im.nucker.functions.api.FunctionRegistry;
import im.nucker.functions.impl.combat.NoEntityTrace;
import im.nucker.functions.impl.misc.BetterMinecraft;
import im.nucker.functions.impl.misc.Unhook;
import im.nucker.functions.impl.render.AspectRatio;
import im.nucker.functions.impl.render.GlassHand;
...
public class GameRenderer implements IResourceManagerReloadListener, AutoCloseable {
    ...
    public Matrix4f getProjectionMatrix(ActiveRenderInfo activeRenderInfoIn, float partialTicks,
        ...
        FunctionRegistry moduleRepository = NuckerDLC.getInstance().getFunctionRegistry();
