...
import im.nucker.events.EventChangeWorld;
import im.nucker.events.TickEvent;
...
import im.nucker.functions.impl.player.ItemCooldown;
import im.nucker.ui.mainmenu.MainScreen;
...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
    ...
    public void setDefaultMinecraftTitle() {
        ...
        if (selfDestruct.unhooked) {
            ...
            this.mainWindow.setWindowTitle("NuckerDLC | Recode");
        }
    }
    ...
    private void tick(boolean isDebug, @Nullable LongTickDetector detector) {
        NuckerDLC.getInstance().getEventBus().post(tickEvent);
    ...
    public void runTick() {
        ...
        if (this.world != null) {
            NuckerDLC.getInstance().getEventBus().post(player.tick);
    ...
    public void loadWorld(ClientWorld worldClientIn) {
        ...
        NuckerDLC.getInstance().getEventBus().post(new EventChangeWorld());
    }
