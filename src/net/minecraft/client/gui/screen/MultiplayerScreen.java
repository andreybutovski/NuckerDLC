...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = NuckerDLC.getInstance().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(NuckerDLC.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        NuckerDLC.getInstance().getViaMCP().viaScreen.tick();
