...
import im.nucker.events.EventStartRiding;
import im.nucker.events.MovingEvent;
import im.nucker.events.PostMoveEvent;
import im.nucker.functions.api.FunctionRegistry;
import im.nucker.functions.impl.combat.Hitbox;
import im.nucker.functions.impl.render.Trails;
import im.nucker.scripts.lua.classes.EntityClass;
...
public abstract class Entity implements INameable, ICommandSource {
    ...
    public void move(MoverType typeIn, Vector3d pos) {
        ...
        if (this.noClip) {
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                NuckerDLC.getInstance().getEventBus().post(move);
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                NuckerDLC.getInstance().getEventBus().post(post);
            }
    ...
    public boolean startRiding(Entity entityIn, boolean force) {
        NuckerDLC.getInstance().getEventBus().post(new EventStartRiding(entityIn));
