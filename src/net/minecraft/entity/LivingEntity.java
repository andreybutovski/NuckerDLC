...
import im.nucker.events.EventDamageReceive;
...
import im.nucker.functions.impl.render.SwingAnimation;
...
public abstract class LivingEntity extends Entity {
    ...
    public boolean onLivingFall(float distance, float damageMultiplier) {
        ...
        if (i > 0) {
            ...
            if (this instanceof ClientPlayerEntity) {
                NuckerDLC.getInstance().getEventBus()
    ...
    protected void jump() {
        ...
        if (this instanceof ClientPlayerEntity entity) {
            NuckerDLC.getInstance().getEventBus().post(jumpEvent);
        }
