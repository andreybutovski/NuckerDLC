...
public class MathHelper
{
    ...
    public static float interpolate(float p_219805_0_, double p_219805_1_, double p_219805_2_) {
        return (float) (p_219805_1_ + p_219805_0_ * wrapDegrees(p_219805_2_ - p_219805_1_));
    }
